...
execute unless entity @s[tag=flor.arid_guardian,tag=flor.arid_dmg] unless entity @s[tag=flor.aqueous_guardian,tag=flor.aqueous_dmg] unless entity @s[tag=flor.verdant_guardian,tag=flor.verdant_dmg] run function florcraft:utils/damage/calculate
