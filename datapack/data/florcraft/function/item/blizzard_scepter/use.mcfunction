...
execute if score $out flor.aqueous_ess matches 1.. run playsound minecraft:block.snow.break player @a ~ ~ ~ 1 0.7
execute if score $out flor.aqueous_ess matches 1.. run playsound minecraft:block.snow.break player @a ~ ~ ~ 1 0.7
execute if score $out flor.aqueous_ess matches 1.. run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["smithed.entity","flor.ticking","flor.blizzard_scepter"]}
...
execute if score $out flor.aqueous_ess matches 1.. if entity @s[predicate=florcraft:item/druidic_lauret] run tag @e[sort=nearest,limit=1,tag=flor.blizzard_scepter] add flor.buffed_magic_25
execute if score $out flor.aqueous_ess matches 1.. if entity @s[predicate=florcraft:item/aqueous_exobiotic_helmet] run tag @e[sort=nearest,limit=1,tag=flor.blizzard_scepter] add flor.buffed_magic_40
execute if score $out flor.aqueous_ess matches 1.. if entity @s[predicate=florcraft:item/aqueous_mastery_circlet] run tag @e[sort=nearest,limit=1,tag=flor.blizzard_scepter] add flor.buffed_magic_50