...
replaceitem entity @s[gamemode=!creative,nbt={Inventory:[{Slot:-106b,tag:{flor_dat:{relilay:1b}}}]},nbt=!{SelectedItem:{tag:{flor_dat:{relilay:1b}}}}] weapon.offhand air
replaceitem entity @s[gamemode=!creative,nbt={SelectedItem:{tag:{flor_dat:{relilay:1b}}}}] weapon.mainhand air
