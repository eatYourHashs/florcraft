...
summon item_frame ~ ~1 ~ {Item:{id:"minecraft:structure_block",Count:1b,tag:{CustomModelData:423018}},Facing:1b,Invulnerable:1b,Tags:["flor.20ticking","flor.ticking","global.ignore","flor.dispoppy","flor.link_flower"],Silent:1b,Fixed:1b,Invisible:1b}
