...
data modify storage flor:storage temp set value {Slot:1b,id:"minecraft:blaze_rod",count:1,tag:{display:{Name:'[{"translate":"block.flor.generic.arid_essence","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423000,flor_dat:{essence:1b,cleared:1}}}
