...
execute if score @s flor.copper matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/copper_cast
...
execute if score @s flor.dcoal matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_coal_cast
execute if score @s flor.dlapis matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_lapis_cast
execute if score @s flor.dgold matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_gold_cast
execute if score @s flor.ddiamond matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_diamond_cast
execute if score @s flor.dredstone matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_redstone_cast
execute if score @s flor.demerald matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_emerald_cast
execute if score @s flor.diron matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_iron_cast
execute if score @s flor.dcopper matches 1.. if data storage flor:storage SelectedItem.tag.flor_dat.raging_river_pickaxe run function florcraft:item/raging_river_pickaxe/deepslate_copper_cast
execute unless score @s flor.since_gui matches 3.. if entity @s[tag=flor.inside_natures_oculus_gui] run function florcraft:entity/player/check_action_scores
execute unless score @s flor.since_gui matches 3.. if entity @s[tag=flor.inside_infused_workbench_gui] run function florcraft:entity/player/check_action_scores
