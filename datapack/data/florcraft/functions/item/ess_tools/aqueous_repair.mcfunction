...
execute in minecraft:overworld if data block -30000000 0 24576 Items[0].components."minecraft:custom_data".flor_dat.raging_river_pickaxe run scoreboard players remove $temp flor.dummy 65
