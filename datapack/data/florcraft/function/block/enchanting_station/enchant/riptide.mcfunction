...
execute unless data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:riptide" run data modify block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:riptide" set value 1
