...
execute if block ~ ~ ~ oak_wood align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=armor_stand,distance=..0.6,tag=flor.sealable] run function florcraft:item/seal/check_block
execute if block ~ ~ ~ stripped_oak_wood align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=armor_stand,distance=..0.6,tag=flor.sealable] run function florcraft:item/seal/check_block
