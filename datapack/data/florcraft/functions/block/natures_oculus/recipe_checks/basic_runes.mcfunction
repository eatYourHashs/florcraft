...
execute if score $temp flor.dummy matches 16.. run scoreboard players set @p[tag=flor.inside_natures_oculus_gui,distance=..12,scores={flor.knowledge=2..}] flor.pages 2
