...
execute unless score @s flor.arid_ess matches 20.. run tag @s[tag=!flor.verdant_filter,tag=!flor.aqueous_filter] add flor.arid_acceptor
execute unless score @s flor.aqueous_ess matches 20.. run tag @s[tag=!flor.verdant_filter,tag=!flor.arid_filter] add flor.aqueous_acceptor
execute unless score @s flor.verdant_ess matches 20.. run tag @s[tag=!flor.arid_filter,tag=!flor.aqueous_filter] add flor.verdant_acceptor
