...
tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_fortunate_seeker_shovel,distance=..12,scores={flor.knowledge=1..}] add flor.know_fortunate_seeker_shovel
