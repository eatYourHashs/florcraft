...
execute if score @s flor.verdant_upg matches 3 run scoreboard players operation $temp flor.dummy *= $cons.2 flor.dummy
execute if score @s flor.verdant_upg matches 2 run scoreboard players operation $temp flor.dummy *= $cons.3 flor.dummy
execute if score @s flor.verdant_upg matches 1 run scoreboard players operation $temp flor.dummy *= $cons.4 flor.dummy
execute unless score @s flor.verdant_upg matches 1.. run scoreboard players operation $temp flor.dummy *= $cons.5 flor.dummy
scoreboard players operation @s flor.ess_time += $temp flor.dummy
