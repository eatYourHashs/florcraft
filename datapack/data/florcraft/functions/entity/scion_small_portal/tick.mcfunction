...
execute if score @s flor.dummy matches 29 run particle block sculk ~ ~0.5 ~ 0.4 0 0.4 0 30
execute positioned ~ ~0.5 ~ if score @s flor.dummy matches 30..60 as @a[distance=..2.8] run damage @s 23 florcraft:scion by @e[tag=flor.scion_small_portal,limit=1,sort=nearest] from @e[tag=flor.scion_hitbox,limit=1,sort=nearest]
