execute if entity @e[type=item,distance=..2,nbt={Item:{id:"minecraft:crimson_fungus",count:1}}] run loot spawn ~ ~ ~ loot florcraft:item/mineroot_sapling
execute if entity @e[type=item,distance=..2,nbt={Item:{id:"minecraft:oak_log",count:1}}] run loot spawn ~ ~ ~ loot florcraft:item/mineroot_sapling
kill @e[type=item,distance=..2,limit=1,nbt={Item:{id:"minecraft:crimson_fungus",count:1}}]
kill @e[type=item,distance=..2,limit=1,nbt={Item:{id:"minecraft:oak_log",count:1}}]
