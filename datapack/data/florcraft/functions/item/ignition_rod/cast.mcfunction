...
execute as @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!flor.attacker,type=!#florcraft:nonattackable,type=!#florcraft:fire_immune,tag=!flor.invoked_arid,nbt={HurtTime:0s}] run function florcraft:item/ignition_rod/damage
