...
execute at @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!smithed.strict,tag=!flor.user,type=!#florcraft:nonattackable,nbt={OnGround:1b}] run function florcraft:item/mending_scepter/other_heal
