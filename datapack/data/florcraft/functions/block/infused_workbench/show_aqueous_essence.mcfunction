...
data modify storage flor:storage temp set value {Slot:23b,id:"minecraft:structure_block",Count:1b,components:{"minecraft:item_name":[{"translate":"block.flor.generic.aqueous_essence","color":"green","font":"minecraft:default","italic":"false"}],"minecraft:lore":[],"minecraft:item_model":"florcraft:aqueous_essence","minecraft:custom_data":{flor_dat:{essence:2b,cleared:1b}}}}
