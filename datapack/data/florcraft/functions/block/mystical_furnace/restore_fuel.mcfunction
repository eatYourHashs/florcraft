data modify storage flor:storage temp prepend from block ~ ~ ~ Items[{Slot:1b}]
execute at @p run summon item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[flor.new_drop]}
