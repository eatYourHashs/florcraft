execute at @p[gamemode=!creative,gamemode=!spectator] run summon item_display ~ ~0.6 ~ {transformation:{left_rotation:[0f,1f,0f,1f],right_rotation:[0f,0f,0f,0f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:potion",Count:1b,tag:{CustomModelData:423008,CustomPotionColor:0}},Tags:[flor.anticipant_small_portal,flor.new_portal,smithed.entity,flor.ticking]}
