...
execute if predicate florcraft:item/verdant_exobiotic_chestplate unless data entity @s equipment.chest.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/chestplate/clear_dot
...
execute if score @s flor.last_tick_sprint matches 1.. if score @s flor.sneak matches 1.. if predicate florcraft:item/aqueous_exobiotic_leggings unless data entity @s equipment.legs.components."minecraft:custom_data".flor_dat{fill:0} unless score @s flor.exo_leggings_count matches 1.. unless score @s flor.exo_leggings_cd matches 1.. run function florcraft:item/exobiotic/leggings/start_dash
execute if score @s flor.exo_leggings_count matches 1.. if predicate florcraft:item/aqueous_exobiotic_leggings unless data entity @s equipment.legs.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/leggings/dash_tick

execute if predicate florcraft:item/arid_exobiotic_leggings unless data entity @s equipment.legs.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/leggings/fire_sprint_tick
...
execute if block ~ ~-0.01 ~ #florcraft:air unless entity @s[tag=flor.not_on_solid_ground] if score @s flor.sneak matches 1.. if predicate florcraft:item/verdant_exobiotic_leggings unless data entity @s equipment.legs.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/leggings/place_block
...
execute if predicate florcraft:item/arid_exobiotic_boots unless data entity @s equipment.feet.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/boots/arid_tick
execute if predicate florcraft:item/aqueous_exobiotic_boots unless data entity @s equipment.feet.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/boots/aqueous_tick
execute if predicate florcraft:item/verdant_exobiotic_boots unless data entity @s equipment.feet.components."minecraft:custom_data".flor_dat{fill:0} run function florcraft:item/exobiotic/boots/verdant_tick
...
execute if score @s flor.since_gui matches 3.. run function florcraft:entity/player/tick/reset_guis
