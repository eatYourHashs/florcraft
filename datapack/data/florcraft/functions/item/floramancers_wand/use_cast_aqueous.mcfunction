...
execute if block ~ ~ ~ crimson_fungus align xyz positioned ~0.5 ~0.5 ~0.5 as @e[type=item_frame,distance=..0.6,tag=flor.echoroot] unless score @s flor.aqueous_ess >= @s flor.aqueous_cap run function florcraft:item/floramancers_wand/insert_aqueous
