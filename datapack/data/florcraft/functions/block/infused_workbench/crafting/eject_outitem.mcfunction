...
execute if data entity @s ArmorItems[3].components."minecraft:custom_data".flor_dat.LastOutput.id run function florcraft:block/infused_workbench/crafting/deduct_inputs