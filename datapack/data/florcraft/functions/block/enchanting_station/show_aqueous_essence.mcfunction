...
data modify storage flor:storage temp set value {Slot:19b,id:"minecraft:structure_block",Count:1b,tag:{display:{Name:'[{"text":"Aqueous Essence","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423007,flor_dat:{essence:2b,cleared:1b}}}
