...
execute if data entity @s Inventory[{Slot:-106b}].tag.flor_dat{ess:"aqueous",pulsating_pustule:1b} if score @s flor.lvl matches 1.. run scoreboard players set $out flor.aqueous_ess 4
