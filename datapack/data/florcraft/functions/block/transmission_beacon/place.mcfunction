...
summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["flor.capacity","flor.20ticking","smithed.block","flor.transmission_beacon","smithed.entity","flor.ticking","flor.sealable"],equipment:{head:{id:"minecraft:dropper",count:1,tag:{Unbreakable:1b,CustomModelData:423024}}}
