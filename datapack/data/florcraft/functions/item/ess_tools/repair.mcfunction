...
execute if score $temp flor.dummy matches 1 run function florcraft:entity/player/get_arid_ess
execute if score $temp flor.dummy matches 2 run function florcraft:entity/player/get_aqueous_ess
execute if score $temp flor.dummy matches 3 run function florcraft:entity/player/get_verdant_ess
