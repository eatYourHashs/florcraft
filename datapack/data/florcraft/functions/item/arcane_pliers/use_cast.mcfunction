...
execute if block ~ ~ ~ oak_wood align xyz positioned ~0.5 ~0.5 ~0.5 as @e[type=armor_stand,distance=..0.6,tag=flor.sealable] run function florcraft:item/arcane_pliers/check
execute if block ~ ~ ~ stripped_oak_wood align xyz positioned ~0.5 ~0.5 ~0.5 as @e[type=armor_stand,distance=..0.6,tag=flor.sealable] run function florcraft:item/arcane_pliers/check
