...
execute if data storage flor:storage SelectedItem.tag.flor_dat{aqueous_upgrade_seal:1b} if entity @s[tag=flor.capacitor] run scoreboard players add @s flor.aqueous_cap 10
execute if data storage flor:storage SelectedItem.tag.flor_dat{verdant_upgrade_seal:1b} if entity @s[tag=flor.capacitor] run scoreboard players add @s flor.verdant_cap 10
execute if data storage flor:storage SelectedItem.tag.flor_dat{arid_upgrade_seal:1b} if entity @s[tag=flor.echoroot] run scoreboard players add @s flor.arid_cap 10
execute if data storage flor:storage SelectedItem.tag.flor_dat{arid_upgrade_seal:1b} if entity @s[tag=flor.echoroot] run scoreboard players add @s flor.aqueous_cap 10
execute if data storage flor:storage SelectedItem.tag.flor_dat{arid_upgrade_seal:1b} if entity @s[tag=flor.echoroot] run scoreboard players add @s flor.verdant_cap 10
