...
execute at @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!smithed.entity,tag=!flor.user,type=!#florcraft:nonattackable,tag=!flor.invoked_verdant,nbt={OnGround:1b}] run function florcraft:item/overgrowth_rod/summon_vine
