...
execute if score @s flor.dummy matches 4 unless entity @s[tag=flor.ice_ready] run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick[minecraft:item_model="florcraft:entity/aqueous_guardian_body_attacking"]
