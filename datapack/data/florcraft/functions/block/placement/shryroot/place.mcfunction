...
summon item_frame ~ ~1 ~ {Item:{id:"minecraft:structure_block",count:1,tag:{CustomModelData:423072}},Facing:1b,Invulnerable:1b,Tags:["flor.20ticking","flor.ticking","smithed.entity","flor.shryroot","flor.connects_to_lily","flor.link_flower","flor.sealable"],Silent:1b,Fixed:1b,Invisible:1b}
