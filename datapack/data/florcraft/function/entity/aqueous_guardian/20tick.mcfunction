...
execute if entity @a[distance=8..20,gamemode=!creative,gamemode=!spectator] run function florcraft:entity/aqueous_guardian/update_targetting
...
execute if score @s flor.dummy matches 4 if entity @a[distance=..20,gamemode=!creative,gamemode=!spectator] run scoreboard players set @s flor.dummy2 5