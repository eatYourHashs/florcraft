...
execute if data entity @s Inventory[{Slot:-106b}].tag.flor_dat{ess:"aqueous"} unless score $temp flor.aqueous_ess matches 1.. run loot replace block -30000000 0 24576 container.0 loot florcraft:item/essence_flask
execute if data entity @s Inventory[{Slot:-106b}].tag.flor_dat{ess:"aqueous"} if score $temp flor.aqueous_ess matches 1..2 run data modify block -30000000 0 24576 Items[0].tag.CustomModelData set value 423004
execute if data entity @s Inventory[{Slot:-106b}].tag.flor_dat{ess:"aqueous"} if score $temp flor.aqueous_ess matches 3..4 run data modify block -30000000 0 24576 Items[0].tag.CustomModelData set value 423005
execute if data entity @s Inventory[{Slot:-106b}].tag.flor_dat{ess:"aqueous"} if score $temp flor.aqueous_ess matches 5 run data modify block -30000000 0 24576 Items[0].tag.CustomModelData set value 423006
