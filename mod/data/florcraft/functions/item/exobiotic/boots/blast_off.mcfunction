...
execute if entity @e[distance=..4,sort=arbitrary,tag=!global.ignore,tag=!flor.user,type=!#florcraft:nonattackable,tag=!flor.invoked_arid,nbt={HurtTime:0s}] run function florcraft:item/exobiotic/boots/blast_off_hit
