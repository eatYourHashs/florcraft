...
execute if block ~ ~ ~ deepslate_gold_ore run function florcraft:entity/player/get_aqueous_ess
execute if block ~ ~ ~ deepslate_gold_ore if score $out flor.aqueous_ess matches 1.. if predicate florcraft:random/one_tenth run function florcraft:entity/player/use_aqueous_ess
