execute store result score $temp flor.dummy run data get storage flor:storage root.enchant_item.components."minecraft:enchantments"."minecraft:blast_protection"
...
execute unless data storage flor:storage root.enchant_item.components."minecraft:enchantments"."minecraft:fire_protection" unless data storage flor:storage root.enchant_item.components."minecraft:enchantments"."minecraft:projectile_protection" unless data storage flor:storage root.enchant_item.components."minecraft:enchantments"."minecraft:protection" unless score $temp flor.dummy matches 5.. if score @s flor.arid_ess >= $temp.0 flor.dummy if score @s flor.aqueous_ess >= $temp.1 flor.dummy if score @s flor.verdant_ess >= $temp.2 flor.dummy run function florcraft:block/enchanting_station/enchant/blast_protection
