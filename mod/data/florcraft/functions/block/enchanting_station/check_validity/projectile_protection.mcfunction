execute store result score $temp flor.dummy run data get storage flor:storage root.enchant_item.tag.Enchantments[{id:"minecraft:projectile_protection"}].lvl
...
execute unless data storage flor:storage root.enchant_item.tag.Enchantments[{id:"minecraft:protection"}] unless data storage flor:storage root.enchant_item.tag.Enchantments[{id:"minecraft:fire_protection"}] unless data storage flor:storage root.enchant_item.tag.Enchantments[{id:"minecraft:blast_protection"}] unless score $temp flor.dummy matches 5.. if score @s flor.arid_ess >= $temp.0 flor.dummy if score @s flor.aqueous_ess >= $temp.1 flor.dummy if score @s flor.verdant_ess >= $temp.2 flor.dummy run function florcraft:block/enchanting_station/enchant/projectile_protection
