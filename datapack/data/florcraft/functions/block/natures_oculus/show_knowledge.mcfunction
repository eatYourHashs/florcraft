...
data modify storage flor:storage temp set value {Slot:1b,id:"minecraft:structure_block",Count:1b,tag:{display:{Name:'[{"translate":"block.flor.natures_occulus.knowlegepoint","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423005,flor_dat:{knowledge:1b,cleared:1b}}}
