...
execute at @e[tag=flor.poppy,limit=1] as @e[tag=flor.arid_acceptor,sort=nearest,tag=flor.in_range] if entity @s[type=player,predicate=florcraft:dispoppy/accepts_arid_reinforced_vessel] run function florcraft:block/dispoppy/add_arid_player_reinforced_vessel
...
execute at @e[tag=flor.poppy,limit=1] as @e[tag=flor.arid_acceptor,sort=nearest,tag=flor.in_range] if entity @s[tag=flor.mineroot_sapling] run function florcraft:block/dispoppy/add_arid_mineroot
