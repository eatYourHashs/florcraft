...
execute if data block ~ ~ ~ Items[{Slot:5b,id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{flor_dat:{essence_flask:1}}}}] unless data block ~ ~ ~ Items[{Slot:5b,id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{flor_dat:{essence_flask:1,fill:0}}}}] run function florcraft:block/infused_workbench/add_flask_essence with block ~ ~ ~ Items[{Slot:5b}].components."minecraft:custom_data".flor_dat
