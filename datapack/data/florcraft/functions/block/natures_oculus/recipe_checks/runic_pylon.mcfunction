...
execute if score $temp flor.dummy matches 2.. run tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_runic_pylons,distance=..12,scores={flor.knowledge=1..}] add flor.know_runic_pylons
