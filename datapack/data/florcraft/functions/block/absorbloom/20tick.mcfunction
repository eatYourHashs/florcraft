execute unless score @s flor.arid_ess matches 1.. unless score @s flor.aqueous_ess matches 1.. unless score @s flor.verdant_ess matches 1.. unless entity @s[tag=flor.disabled] run function florcraft:block/absorbloom/attempt_take_ess
