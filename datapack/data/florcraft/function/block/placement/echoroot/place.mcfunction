...
item modify entity @s[gamemode=!creative,nbt={equipment:{offhand:{components:{"minecraft:custom_data":{flor_dat:{echoroot:1b}}}}}},nbt=!{SelectedItem:{components:{"minecraft:custom_data":{flor_dat:{echoroot:1b}}}}}] weapon.offhand florcraft:deduct_count
