...
execute if block ~ ~ ~ emerald_ore run function florcraft:entity/player/get_ess/aqueous_ess
execute if block ~ ~ ~ emerald_ore if score $out flor.aqueous_ess matches 1.. if predicate florcraft:random/one_tenth run function florcraft:entity/player/use_ess/aqueous_ess
