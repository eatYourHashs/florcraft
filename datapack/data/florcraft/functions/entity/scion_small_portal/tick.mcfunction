...
execute positioned ~ ~0.5 ~ if score @s flor.dummy matches 30..60 as @a[distance=..2.6] run damage @s 20 florcraft:scion by @e[tag=flor.scion_small_portal,limit=1,sort=nearest] from @e[tag=flor.scion_hitbox,limit=1,sort=nearest]
