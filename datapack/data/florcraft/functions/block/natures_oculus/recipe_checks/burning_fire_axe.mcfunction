data modify block -30000000 0 24576 Items prepend from block ~ ~ ~ Items[{Slot:22b}]
execute store result score $temp flor.dummy run data get block -30000000 0 24576 Items[0].Count
tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_burning_fire_axe,distance=..12,scores={flor.knowledge=1..}] add flor.know_burning_fire_axe
