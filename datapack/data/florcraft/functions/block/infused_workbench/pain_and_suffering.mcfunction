...
#execute if score $temp.out1 flor.dummy matches 1 run say outcopy =/= outslotitem
#execute unless score $temp.out1 flor.dummy matches 1 run say outcopy == outslotitem
#execute if score $temp.out2 flor.dummy matches 1 run say outcopy =/= lastoutput
#execute unless score $temp.out2 flor.dummy matches 1 run say outcopy == lastoutput
