data modify block -30000000 0 24576 Items prepend from block ~ ~ ~ Items[{Slot:20b}]
execute store result score $temp flor.dummy run data get block -30000000 0 24576 Items[0].Count
execute if score $temp flor.dummy matches 2.. run tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_attuned_pylons,distance=..12,scores={flor.knowledge=1..}] add flor.know_attuned_pylons
