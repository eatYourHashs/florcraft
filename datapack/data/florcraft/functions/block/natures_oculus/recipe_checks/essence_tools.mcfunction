data modify block -30000000 0 24576 Items prepend from block ~ ~ ~ Items[{Slot:19b}]
execute store result score $temp flor.dummy run data get block -30000000 0 24576 Items[0].Count
tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_essence_tools,distance=..12,scores={flor.knowledge=1..}] add flor.know_essence_tools
