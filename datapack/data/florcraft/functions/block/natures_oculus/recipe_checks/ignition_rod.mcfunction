...
execute if score $temp flor.dummy matches 4.. run tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_ignition_rod,distance=..12,scores={flor.knowledge=1..}] add flor.know_ignition_rod
