...
execute if data entity @s SelectedItem.tag.flor_dat{ess:"arid"} run scoreboard players operation $temp flor.dummy += @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.arid_ess
execute if data entity @s SelectedItem.tag.flor_dat{ess:"arid"} run scoreboard players set @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.arid_ess 0
execute unless data entity @s SelectedItem.tag.flor_dat.ess run scoreboard players operation $temp flor.dummy += @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.arid_ess
execute unless data entity @s SelectedItem.tag.flor_dat.ess run scoreboard players set @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.arid_ess 0
