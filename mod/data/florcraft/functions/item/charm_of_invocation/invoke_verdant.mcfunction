...
summon wolf ~ ~ ~ {DeathLootTable:"minecraft:empty",CollarColor:5b,Tags:["flor.20ticking","flor.ticking","flor.verdant_invo_wolf"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:40,ShowParticles:0b}]}
summon wolf ~ ~ ~ {DeathLootTable:"minecraft:empty",CollarColor:5b,Tags:["flor.20ticking","flor.ticking","flor.verdant_invo_wolf"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:40,ShowParticles:0b}]}
summon wolf ~ ~ ~ {DeathLootTable:"minecraft:empty",CollarColor:5b,Tags:["flor.20ticking","flor.ticking","flor.verdant_invo_wolf"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:40,ShowParticles:0b}]}
