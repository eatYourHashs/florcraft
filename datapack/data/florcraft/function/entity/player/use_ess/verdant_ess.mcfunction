...
execute if score $temp.math flor.dummy matches 1.. unless data entity @s equipment.offhand.components."minecraft:custom_data".flor_dat{pulsating_pustule:1} run item modify entity @s weapon.offhand florcraft:set_cmd/verdant
