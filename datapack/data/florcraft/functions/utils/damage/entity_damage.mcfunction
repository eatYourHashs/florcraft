...
kill @s[scores={flor.dummy=..0},tag=!smithed.strict]
...
execute if entity @s[type=minecraft:piglin_brute] as @e[type=minecraft:piglin,distance=..16,tag=!smithed.entity] run function florcraft:utils/damage/brain_aggro
