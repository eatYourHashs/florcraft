...
execute if entity @s[tag=flor.valid,tag=flor.toggled] if score @s flor.arid_ess matches ..19 run tag @s add flor.arid_acceptor
execute if entity @s[tag=flor.valid,tag=flor.toggled] if score @s flor.aqueous_ess matches ..19 run tag @s add flor.aqueous_acceptor
execute if entity @s[tag=flor.valid,tag=flor.toggled] if score @s flor.verdant_ess matches ..19 run tag @s add flor.verdant_acceptor
