...
data modify storage flor:storage temp set value {Slot:22b,id:"minecraft:structure_block",Count:1b,tag:{display:{Name:'[{"text":"Arid Essence","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423006,flor_dat:{essence:1b,cleared:1b}}}
