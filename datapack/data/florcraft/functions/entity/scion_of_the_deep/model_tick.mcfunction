...
execute if score @s flor.dummy matches 160.. if entity @s[tag=!flor.yank,tag=!flor.slam,tag=!flor.right_beam,tag=!flor.left_beam,tag=!flor.in_bolts,tag=!flor.out_bolts,tag=!flor.back_strike,tag=!flor.phase_transition,tag=!flor.slam_p2,tag=!flor.in_bolts_p2,tag=!flor.out_bolts_p2,tag=!flor.voidgate,tag=!flor.whirlwind] run scoreboard players set @s flor.dummy 140
