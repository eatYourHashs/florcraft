...
execute if score @s flor.dummy matches 20.. if entity @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,tag=!flor.invoked_verdant,nbt={HurtTime:0s,OnGround:1b}] run function florcraft:item/snare_scepter/snare
