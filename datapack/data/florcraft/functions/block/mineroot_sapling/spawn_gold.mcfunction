...
execute unless score @s flor.gold matches 65.. store result entity @e[tag=flor.new_drop,limit=1,sort=nearest] Item.count int 1 run scoreboard players get @s flor.gold
