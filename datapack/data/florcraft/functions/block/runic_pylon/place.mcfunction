setblock ~ ~ ~ oak_wood
summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["flor.capacity","flor.interacts_with_bloom","smithed.block","flor.20ticking","flor.runic_pylon","flor.pylon_variant","smithed.entity","flor.ticking","flor.sealable"],equipment:{head:{id:"minecraft:dropper",count:1,tag:{Unbreakable:1b,CustomModelData:423005}}}
