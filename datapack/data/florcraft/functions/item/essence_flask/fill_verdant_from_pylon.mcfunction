...
execute if data entity @s SelectedItem.tag.flor_dat{ess:"verdant"} run scoreboard players operation $temp flor.dummy += @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.verdant_ess
execute if data entity @s SelectedItem.tag.flor_dat{ess:"verdant"} run scoreboard players set @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.verdant_ess 0
execute unless data entity @s SelectedItem.tag.flor_dat.ess run scoreboard players operation $temp flor.dummy += @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.verdant_ess
execute unless data entity @s SelectedItem.tag.flor_dat.ess run scoreboard players set @e[type=armor_stand,distance=..0.6,tag=flor.pylon] flor.verdant_ess 0
