...
execute if data entity @s Inventory[{Slot:-106b}].tag.flor_dat{ess:"arid",pulsating_pustule:1b} if score @s flor.lvl matches 1.. run scoreboard players set $out flor.arid_ess 4
