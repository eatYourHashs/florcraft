...
execute if entity @s[tag=flor.arid_orb] run tag @e[distance=..4,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,type=!#florcraft:fire_immune,tag=!flor.invoked_arid,nbt={HurtTime:0s}] add flor.arid_dmg
execute if entity @s[tag=flor.aqueous_orb] run tag @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,tag=!flor.invoked_aqueous,nbt={HurtTime:0s}] add flor.aqueous_dmg
execute if entity @s[tag=flor.verdant_orb] run tag @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,tag=!flor.invoked_verdant,nbt={HurtTime:0s}] add flor.verdant_dmg
execute if entity @s[tag=flor.aqueous_orb] run effect give @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,tag=!flor.invoked_aqueous,nbt={HurtTime:0s}] slowness 10 3 true
