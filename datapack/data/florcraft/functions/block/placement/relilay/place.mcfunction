...
item modify entity @s[gamemode=!creative,nbt={Inventory:[{Slot:-106b,tag:{flor_dat:{relilay:1b}}}]},nbt=!{SelectedItem:{components:{"minecraft:custom_data":{flor_dat:{relilay:1b}}}}}] weapon.offhand florcraft:deduct_count
