execute unless score @s flor.arid_ess >= @s flor.arid_cap unless score @s flor.aqueous_ess >= @s flor.aqueous_cap unless score @s flor.verdant_ess >= @s flor.verdant_cap unless entity @s[tag=flor.disabled] run function florcraft:block/echoroot/attempt_take_ess
