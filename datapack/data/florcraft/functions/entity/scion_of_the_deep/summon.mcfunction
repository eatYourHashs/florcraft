...
summon giant ~ ~ ~ {Silent:1b,PortalCooldown:150,DeathLootTable:"florcraft:entity/scion_of_the_deep",PersistenceRequired:1b,NoAI:1b,Health:1000f,Tags:["smithed.entity","smithed.strict","flor.ticking","flor.scion","flor.scion_hitbox","flor.new_scion","flor.20ticking"],CustomName:'{"text":"Scion of the Deep"}',ActiveEffects:[{Id:14,Amplifier:1b,Duration:100,ShowParticles:1b},{Id:11,Amplifier:4b,Duration:140,ShowParticles:1b}],Attributes:[{Name:generic.max_health,Base:1000},{Name:generic.knockback_resistance,Base:1},{Name:generic.movement_speed,Base:0},{Name:generic.attack_damage,Base:0},{Name:generic.armor,Base:0},{Name:generic.armor_toughness,Base:0}]}
