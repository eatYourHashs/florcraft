...
execute if score $out flor.arid_ess matches 2.. run summon marker ~ ~ ~ {Tags:["smithed.entity","flor.ticking","flor.spirit_orb","flor.arid_orb"]}
...
execute if score $out flor.aqueous_ess matches 2.. run summon marker ~ ~ ~ {Tags:["smithed.entity","flor.ticking","flor.spirit_orb","flor.aqueous_orb"]}
...
execute if score $out flor.verdant_ess matches 2.. run summon marker ~ ~ ~ {Tags:["smithed.entity","flor.ticking","flor.spirit_orb","flor.verdant_orb"]}
