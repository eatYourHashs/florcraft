...
execute if data block ~ ~ ~ Items[{Slot:1b}] unless data block ~ ~ ~ Items[{Slot:1b}].components."minecraft:custom_data".flor_dat.essence run function florcraft:block/mystical_furnace/restore_fuel
