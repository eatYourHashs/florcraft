...
advancement revoke @s only florcraft:technical/verdant_mastery_circlet_equip
...
schedule function florcraft:item/verdant_mastery_circlet/remove_ignore_tag 1t