...
item modify entity @s[gamemode=!creative,nbt={Inventory:[{Slot:-106b,tag:{flor_dat:{relilay:1b}}}]},nbt=!{SelectedItem:{tag:{flor_dat:{relilay:1b}}}}] weapon.offhand florcraft:deduct_count
item modify entity @s[gamemode=!creative,nbt={SelectedItem:{tag:{flor_dat:{relilay:1b}}}}] weapon.mainhand florcraft:deduct_count
