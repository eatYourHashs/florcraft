...
execute if score @s flor.sneak matches 1.. if score $out flor.arid_ess matches 1.. positioned ~ ~1.8 ~ run function florcraft:item/floramancers_wand/use_cast_arid
execute if score @s flor.sneak matches 1.. if score $out flor.aqueous_ess matches 1.. positioned ~ ~1.8 ~ run function florcraft:item/floramancers_wand/use_cast_aqueous
execute if score @s flor.sneak matches 1.. if score $out flor.verdant_ess matches 1.. positioned ~ ~1.8 ~ run function florcraft:item/floramancers_wand/use_cast_verdant
