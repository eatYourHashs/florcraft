...
execute if entity @s[tag=flor.arid_take] as @e[type=armor_stand,tag=flor.take_ess,scores={flor.arid_ess=1..}] if score @s flor.arid_ess >= $temp flor.dummy at @s facing entity @e[tag=flor.bloom] feet run function florcraft:block/relilay/arid_cast
execute if entity @s[tag=flor.aqueous_take] as @e[type=armor_stand,tag=flor.take_ess,scores={flor.aqueous_ess=1..}] if score @s flor.aqueous_ess >= $temp flor.dummy at @s facing entity @e[tag=flor.bloom] feet run function florcraft:block/relilay/aqueous_cast
execute if entity @s[tag=flor.verdant_take] as @e[type=armor_stand,tag=flor.take_ess,scores={flor.verdant_ess=1..}] if score @s flor.verdant_ess >= $temp flor.dummy at @s facing entity @e[tag=flor.bloom] feet run function florcraft:block/relilay/verdant_cast
