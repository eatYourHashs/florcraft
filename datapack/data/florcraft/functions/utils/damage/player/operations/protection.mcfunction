...
scoreboard players operation flor.temp_1 flor.dummy *= flor.const.100 flor.dummy
  # Divide by 25 per the formula
scoreboard players operation flor.temp_1 flor.dummy /= flor.const.25 flor.dummy
