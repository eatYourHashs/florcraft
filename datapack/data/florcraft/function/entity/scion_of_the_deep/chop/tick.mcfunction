...
execute if score @s flor.dummy matches 141..197 facing entity @p[gamemode=!spectator] feet run tp @s ~ ~ ~ ~ 0
execute if score @s flor.dummy matches 197 run function florcraft:entity/scion_of_the_deep/chop/attack
