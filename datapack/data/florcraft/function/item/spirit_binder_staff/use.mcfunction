...
execute if score $out flor.arid_ess matches 2.. run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["smithed.entity","flor.ticking","flor.spirit_orb","flor.arid_orb"]}
...
execute if score $out flor.aqueous_ess matches 2.. run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["smithed.entity","flor.ticking","flor.spirit_orb","flor.aqueous_orb"]}
...
execute if score $out flor.verdant_ess matches 2.. run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:0b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["smithed.entity","flor.ticking","flor.spirit_orb","flor.verdant_orb"]}
