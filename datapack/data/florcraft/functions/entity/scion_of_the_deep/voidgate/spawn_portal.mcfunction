summon item_display ~ ~ ~ {transformation:{left_rotation:{axis:[0f,1f,0f],angle:0f},right_rotation:{axis:[0f,1f,0f],angle:3.142f},translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:potion",Count:1b,tag:{CustomModelData:423019,CustomPotionColor:0}},Tags:[flor.scion_large_portal,flor.new_portal,smithed.entity,flor.ticking]}
