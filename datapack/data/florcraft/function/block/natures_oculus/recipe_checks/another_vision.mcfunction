...
execute if score $temp flor.dummy matches 4.. run data modify block ~ ~ ~ Items append value {Slot:8b,id:"minecraft:structure_block",count:1,components:{"minecraft:item_name":{"translate":"block.flor.natures_oculus.next","color":"white","italic":false},"minecraft:item_model":"florcraft:right_arrow","minecraft:custom_data":{flor_dat:{next_button:1,cleared:1b}}}}
