...
data modify storage flor:storage temp set value {Slot:1b,id:"minecraft:structure_block",count:1,tag:{display:{Name:'[{"translate":"block.flor.natures_oculus.knowlegepoint","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423005,flor_dat:{knowledge:1,cleared:1}}}
