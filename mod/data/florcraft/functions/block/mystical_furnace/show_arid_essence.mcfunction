...
data modify storage flor:storage temp set value {Slot:1b,id:"minecraft:blaze_rod",Count:1b,tag:{display:{Name:'[{"text":"Arid Essence","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423000,flor_dat:{essence:1b,cleared:1b}}}
