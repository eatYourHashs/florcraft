...
execute at @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,tag=!flor.user,nbt={OnGround:1b}] run function florcraft:item/overgrowth_rod/summon_vine
