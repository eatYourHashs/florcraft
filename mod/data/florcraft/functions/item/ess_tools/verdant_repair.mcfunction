...
execute in minecraft:overworld if data block -30000000 0 24576 Items[0].tag.flor_dat.fortunate_seeker_shovel run scoreboard players remove $temp flor.dummy 65
execute in minecraft:overworld if data block -30000000 0 24576 Items[0].tag.flor_dat.bountiful_earth_hoe run scoreboard players remove $temp flor.dummy 65
