...
execute if score @s flor.dummy matches 180.. if entity @s[tag=!flor.yank,tag=!flor.slam,tag=!flor.right_beam,tag=!flor.left_beam,tag=!flor.in_bolts,tag=!flor.out_bolts,tag=!flor.back_strike] run scoreboard players set @s flor.dummy 140
