...
execute store success score $temp.out2 flor.dummy run data modify storage flor:crafting OutputCopy set from entity @s equipment.head.components."minecraft:custom_data".flor_dat.LastOutput
...
execute if data entity @s equipment.head.components."minecraft:custom_data".flor_dat.LastOutput.id unless data storage flor:crafting OutSlotItem run function florcraft:block/infused_workbench/crafting/deduct_inputs
data modify entity @s equipment.head.components."minecraft:custom_data".flor_dat.LastOutput set from block ~ ~ ~ Items[{Slot:16b}]
execute unless data block ~ ~ ~ Items[{Slot:16b}] run data modify entity @s equipment.head.components."minecraft:custom_data".flor_dat.LastOutput set value {Slot:16b}
