...
execute if score $temp flor.dummy matches 1 if score $out flor.arid_ess matches 1.. run function florcraft:item/ess_tools/do_repair {ess:"arid"}
execute if score $temp flor.dummy matches 2 if score $out flor.aqueous_ess matches 1.. run function florcraft:item/ess_tools/do_repair {ess:"aqueous"}
execute if score $temp flor.dummy matches 3 if score $out flor.verdant_ess matches 1.. run function florcraft:item/ess_tools/do_repair {ess:"verdant"}