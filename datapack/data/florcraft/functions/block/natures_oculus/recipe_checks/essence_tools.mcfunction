...
tag @s[tag=!flor.know_essence_tools,scores={flor.knowledge=1..}] add flor.know_essence_tools
...
data modify entity @e[type=item,tag=flor.new_drop] Item set from storage flor:temp Items[{Slot:19b}]
