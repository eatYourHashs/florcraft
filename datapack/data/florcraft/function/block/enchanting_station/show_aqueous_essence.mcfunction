...
data modify storage flor:storage temp set value {Slot:19b,id:"minecraft:structure_block",count:1,components:{"minecraft:item_name":[{"translate":"block.flor.generic.aqueous_essence","color":"green","font":"minecraft:default","italic":"false"}],"minecraft:lore":[],"minecraft:item_model":"florcraft:aqueous_essence","minecraft:custom_data":{flor_dat:{essence:2b,cleared:1b}}}}
