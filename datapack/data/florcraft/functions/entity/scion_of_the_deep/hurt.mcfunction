...
execute if score $temp.hp flor.dummy matches ..0 as @e[tag=flor.scion_model,limit=1,sort=nearest] run function florcraft:entity/scion_of_the_deep/death_anim/init