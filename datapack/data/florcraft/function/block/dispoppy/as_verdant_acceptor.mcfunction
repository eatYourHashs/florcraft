...
execute if entity @s[type=item_frame,tag=!smithed.entity,nbt={Item:{components:{"minecraft:custom_data":{flor_dat:{essence_flask:1b}}}}}] run function florcraft:block/dispoppy/add_verdant_frame_flask
execute if entity @s[type=item_frame,tag=!smithed.entity,nbt={Item:{components:{"minecraft:custom_data":{flor_dat:{essence_vessel:1b}}}}}] run function florcraft:block/dispoppy/add_verdant_frame_vessel
execute if entity @s[type=item_frame,tag=!smithed.entity,nbt={Item:{components:{"minecraft:custom_data":{flor_dat:{reinforced_vessel:1b}}}}}] run function florcraft:block/dispoppy/add_verdant_frame_reinforced_vessel