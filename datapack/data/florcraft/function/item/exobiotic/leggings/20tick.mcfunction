#filling
data modify storage flor:storage root.temp.item set from entity @s equipment.legs
execute store result score $temp.ess flor.dummy run data get storage flor:storage root.temp.item.components."minecraft:custom_data".flor_dat.exobiotic_leggings
