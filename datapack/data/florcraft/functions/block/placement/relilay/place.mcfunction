...
summon item_frame ~ ~1 ~ {Item:{id:"minecraft:structure_block",Count:1b,tag:{CustomModelData:423019}},Facing:1b,Invulnerable:1b,Tags:["flor.ticking","flor.20ticking","global.ignore","flor.relilay","flor.connects_to_lily"],Silent:1b,Fixed:1b,Invisible:1b}
