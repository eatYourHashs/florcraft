...
execute at @s if data entity @s SelectedItem.components."minecraft:custom_data".flor_dat{ess:aqueous} run particle minecraft:dust{color:[0.302f,0.318f,1f],scale:1f} ~ ~0.5 ~ 0.2 0.4 0.2 1 30
execute at @s if data entity @s SelectedItem.components."minecraft:custom_data".flor_dat{ess:verdant} run particle minecraft:dust{color:[0f,0.878f,0.322f],scale:1f} ~ ~0.5 ~ 0.2 0.4 0.2 1 30
