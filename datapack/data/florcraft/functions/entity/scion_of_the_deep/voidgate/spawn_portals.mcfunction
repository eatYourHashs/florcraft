...
execute positioned ^-42 ^3 ^8 run function florcraft:entity/scion_of_the_deep/voidgate/spawn_portal
execute positioned ^-36 ^3 ^8 run function florcraft:entity/scion_of_the_deep/voidgate/spawn_portal
execute positioned ^-30 ^3 ^8 run function florcraft:entity/scion_of_the_deep/voidgate/spawn_portal
execute unless score $math.out_0 flor.dummy matches 1 positioned ^-24 ^3 ^8 run function florcraft:entity/scion_of_the_deep/voidgate/spawn_portal
execute unless score $math.out_0 flor.dummy matches 2 positioned ^-18 ^3 ^8 run function florcraft:entity/scion_of_the_deep/voidgate/spawn_portal
