...
data modify storage flor:storage temp set value {Slot:20b,id:"minecraft:structure_block",Count:1b,components:{"minecraft:item_name":[{"translate":"block.flor.generic.verdant_essence","color":"green","font":"minecraft:default","italic":"false"}],"minecraft:lore":[],"minecraft:item_model":"florcraft:verdant_essence","minecraft:custom_data":{flor_dat:{essence:3b,cleared:1b}}}}
