...
execute if data block ~ ~ ~ Items[{Slot:5b}].components."minecraft:custom_data".flor_dat{ess:"arid"} run scoreboard players operation @s flor.arid_ess += $temp flor.dummy
execute if data block ~ ~ ~ Items[{Slot:5b}].components."minecraft:custom_data".flor_dat{ess:"aqueous"} run scoreboard players operation @s flor.aqueous_ess += $temp flor.dummy
execute if data block ~ ~ ~ Items[{Slot:5b}].components."minecraft:custom_data".flor_dat{ess:"verdant"} run scoreboard players operation @s flor.verdant_ess += $temp flor.dummy
