...
execute if entity @e[distance=..2,sort=arbitrary,tag=!smithed.entity,tag=!flor.user,type=!#florcraft:nonattackable,tag=!flor.invoked_aqueous,nbt={HurtTime:0s}] run function florcraft:item/exobiotic/leggings/dash_hit
