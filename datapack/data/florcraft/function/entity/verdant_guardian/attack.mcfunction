...
execute if entity @a[distance=..6,gamemode=!creative,gamemode=!spectator] align xyz positioned ~0.5 ~ ~0.5 run function florcraft:entity/verdant_guardian/spike/spawn_spread
