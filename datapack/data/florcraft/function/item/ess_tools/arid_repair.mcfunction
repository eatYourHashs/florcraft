...
execute in minecraft:overworld if data block -30000000 0 24576 Items[0].components."minecraft:custom_data".flor_dat.scorching_arc_sword run scoreboard players remove $temp flor.dummy 65
execute in minecraft:overworld if data block -30000000 0 24576 Items[0].components."minecraft:custom_data".flor_dat.burning_fire_axe run scoreboard players remove $temp flor.dummy 65
