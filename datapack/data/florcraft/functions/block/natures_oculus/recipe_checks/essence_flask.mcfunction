...
execute if score $temp flor.dummy matches 10.. run tag @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_essence_flask,distance=..12,scores={flor.knowledge=1..}] add flor.know_essence_flask
