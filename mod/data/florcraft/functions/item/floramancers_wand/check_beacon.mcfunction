...
scoreboard players operation @p[gamemode=!spectator] flor.stored_id = @s flor.dummy
scoreboard players set @p[gamemode=!spectator] manic.hide_sanity 60
title @p[gamemode=!spectator] actionbar ["",{"text":"\ue000","font":"florcraft:essences"},{"score":{"name":"@s","objective":"flor.arid_ess"},"color":"#FF9138"},{"text":"/20","color":"#FF9138"}," ",{"text":"\ue001","font":"florcraft:essences"},{"score":{"name":"@s","objective":"flor.aqueous_ess"},"color":"#4D51FF"},{"text":"/20","color":"#4D51FF"}," ",{"text":"\ue002","font":"florcraft:essences"},{"score":{"name":"@s","objective":"flor.verdant_ess"},"color":"#00E052"},{"text":"/20","color":"#00E052"},{"text":" | Beacon stored","color":"#FFFFFF"}]
