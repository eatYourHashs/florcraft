...
execute if block ~ ~ ~ deepslate_iron_ore run function florcraft:entity/player/get_ess/aqueous_ess
execute if block ~ ~ ~ deepslate_iron_ore if score $out flor.aqueous_ess matches 1.. if predicate florcraft:random/one_tenth run function florcraft:entity/player/use_ess/aqueous_ess
