...
execute if score @s flor.dummy matches 4 run playsound minecraft:entity.evoker_fangs.attack hostile @a ~ ~ ~ 1 0.5
execute if score @s flor.dummy matches 4 if entity @a[distance=6..20,gamemode=!creative,gamemode=!spectator] run effect give @s slowness 2 99 true