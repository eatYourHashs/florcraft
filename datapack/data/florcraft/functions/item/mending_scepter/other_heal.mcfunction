...
effect give @e[distance=..5,sort=nearest,limit=1,tag=!smithed.strict,tag=!flor.user,type=!#florcraft:nonattackable] instant_health
scoreboard players set @s flor.mending_cd 100
