...
execute if entity @s[tag=flor.verdant_orb] as @s at @s anchored eyes facing entity @e[sort=nearest,limit=1,distance=..16,tag=!global.ignore,type=#florcraft:hostile] eyes positioned ^ ^ ^0.5 rotated as @s positioned ^ ^ ^10 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ~ ~ ~ ~ ~
tp @s ^ ^ ^0.1
