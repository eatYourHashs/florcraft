tp @e[distance=..1,sort=nearest,limit=1,tag=flor.vined] @s
scoreboard players add @s flor.dummy 1
execute if score @s flor.dummy matches 200.. run tag @e[distance=..1,sort=nearest,limit=1,tag=flor.vined] remove flor.vined
