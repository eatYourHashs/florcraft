...
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".flor_dat{ess:"verdant"} store result storage flor:process Items[0].components."minecraft:custom_data".flor_dat.fill int 1 run scoreboard players get $temp flor.verdant_ess
