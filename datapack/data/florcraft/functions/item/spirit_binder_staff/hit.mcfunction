...
execute if entity @s[tag=flor.aqueous_orb] run effect give @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,nbt={HurtTime:0s}] slowness 10 2 true
execute if entity @s[tag=flor.verdant_orb] run effect give @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,nbt={HurtTime:0s}] poison 6 1 true
execute if entity @s[tag=flor.arid_orb] as @e[distance=..4,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,type=!#florcraft:fire_immune,nbt={HurtTime:0s}] run function florcraft:utils/damage/damage
execute unless entity @s[tag=flor.arid_orb] as @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!global.ignore,type=!#florcraft:nonattackable,nbt={HurtTime:0s}] run function florcraft:utils/damage/damage
kill @s