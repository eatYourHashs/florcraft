...
data modify storage flor:storage temp set value {Slot:24b,id:"minecraft:structure_block",Count:1b,tag:{display:{Name:'[{"translate":"block.flor.generic.verdant_essence","color":"green","font":"minecraft:default","italic":"false"}]',Lore:[]},CustomModelData:423008,flor_dat:{essence:3b,cleared:1b}}}
