...
execute unless data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:sweeping_edge" run data modify block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:sweeping_edge" set value 1
