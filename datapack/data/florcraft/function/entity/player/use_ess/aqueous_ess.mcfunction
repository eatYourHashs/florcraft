...
execute if data entity @s equipment.offhand.components."minecraft:custom_data".flor_dat{essence_item:2} run return run loot replace entity @s weapon.offhand loot florcraft:item/with/aqueous_essence_from_score
