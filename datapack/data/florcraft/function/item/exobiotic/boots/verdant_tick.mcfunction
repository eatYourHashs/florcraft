execute unless score @s flor.exo_boots_cd matches 1.. unless block ~ ~1.0 ~0.6 #florcraft:not_solid if predicate florcraft:jump run function florcraft:item/exobiotic/boots/verdant_latch
execute unless score @s flor.exo_boots_cd matches 1.. unless block ~ ~1.0 ~-0.6 #florcraft:not_solid if predicate florcraft:jump run function florcraft:item/exobiotic/boots/verdant_latch
execute unless score @s flor.exo_boots_cd matches 1.. unless block ~0.6 ~1.0 ~ #florcraft:not_solid if predicate florcraft:jump run function florcraft:item/exobiotic/boots/verdant_latch
execute unless score @s flor.exo_boots_cd matches 1.. unless block ~-0.6 ~1.0 ~ #florcraft:not_solid if predicate florcraft:jump run function florcraft:item/exobiotic/boots/verdant_latch
...
execute unless score @s flor.exo_boots_cd matches 1.. store success score $temp flor.dummy unless predicate florcraft:jump run attribute @s minecraft:gravity modifier remove verdant_latch
