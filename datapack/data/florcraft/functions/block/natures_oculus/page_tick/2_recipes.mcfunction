...
# Runic Pylons
execute if entity @s[tag=flor.know_essence_vessel,tag=!flor.know_runic_pylons,scores={flor.knowledge=1..}] if data storage flor:temp Items[{Slot:17b,tag:{flor_dat:{basic_rune:1b}}}] run function florcraft:block/natures_oculus/recipe_checks/runic_pylon
# Essence Alloys
...
# Burning Fire Axe
execute if entity @s[tag=flor.know_essence_tools,tag=!flor.know_burning_fire_axe,scores={flor.knowledge=1..}] if data storage flor:temp Items[{Slot:22b,id:"minecraft:iron_axe",tag:{flor_dat:{ess_tool:1b}}}] run function florcraft:block/natures_oculus/recipe_checks/burning_fire_axe
# Raging River Pickaxe
execute if entity @s[tag=flor.know_essence_tools,tag=!flor.know_raging_river_pickaxe,scores={flor.knowledge=1..}] if data storage flor:temp Items[{Slot:23b,id:"minecraft:iron_pickaxe",tag:{flor_dat:{ess_tool:2b}}}] run function florcraft:block/natures_oculus/recipe_checks/raging_river_pickaxe
# Fortunate Seeker Shovel
execute if entity @s[tag=flor.know_essence_tools,tag=!flor.know_fortunate_seeker_shovel,scores={flor.knowledge=1..}] if data storage flor:temp Items[{Slot:24b,id:"minecraft:iron_shovel",tag:{flor_dat:{ess_tool:3b}}}] run function florcraft:block/natures_oculus/recipe_checks/fortunate_seeker_shovel
# Bountiful Earth Hoe
execute if entity @s[tag=flor.know_essence_tools,tag=!flor.know_bountiful_earth_hoe,scores={flor.knowledge=1..}] if data storage flor:temp Items[{Slot:25b,id:"minecraft:iron_hoe",tag:{flor_dat:{ess_tool:3b}}}] run function florcraft:block/natures_oculus/recipe_checks/bountiful_earth_hoe
# Druidic Lauret
execute if entity @s[tag=!flor.know_druidic_lauret,scores={flor.knowledge=1..}] if data storage flor:temp Items[{Slot:26b,tag:{flor_dat:{basic_rune:1b}}}] run function florcraft:block/natures_oculus/recipe_checks/druidic_lauret
