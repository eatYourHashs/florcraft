...
data modify storage flor:storage temp set value {Slot:22b,id:"minecraft:structure_block",Count:1b,components:{"minecraft:item_name":[{"translate":"block.flor.generic.arid_essence","color":"green","font":"minecraft:default","italic":"false"}],"minecraft:lore":[],"minecraft:item_model":"florcraft:arid_essence","minecraft:custom_data":{flor_dat:{essence:1b,cleared:1b}}}}
