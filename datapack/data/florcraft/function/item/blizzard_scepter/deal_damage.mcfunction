...
effect give @e[dx=0,dz=0,dy=0,distance=..5,sort=arbitrary,tag=!smithed.strict,type=!#florcraft:nonattackable,tag=!flor.invoked_aqueous,nbt={HurtTime:0s}] slowness 6 2 true
