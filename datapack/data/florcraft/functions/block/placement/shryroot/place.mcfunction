...
item replace entity @s[gamemode=!creative,nbt={Inventory:[{Slot:-106b,tag:{flor_dat:{echoroot:1b}}}]},nbt=!{SelectedItem:{tag:{flor_dat:{shryroot:1b}}}}] weapon.offhand with air
item replace entity @s[gamemode=!creative,nbt={SelectedItem:{tag:{flor_dat:{shryroot:1b}}}}] weapon.mainhand with air
