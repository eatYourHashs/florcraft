...
execute if score @s flor.page matches 1 if entity @p[tag=flor.inside_natures_oculus_gui,tag=!flor.know_druidic_scepter,distance=..12,scores={flor.knowledge=1..}] unless entity @p[tag=flor.inside_natures_oculus_gui,tag=flor.know_druidic_scepter,distance=..12] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:stick"}] run function florcraft:block/natures_oculus/recipe_checks/druidic_scepter
...
execute if score @s flor.page matches 1 unless entity @p[tag=flor.inside_natures_oculus_gui,tag=flor.know_druidic_scepter,distance=..12] unless data block ~ ~ ~ Items[{Slot:10b}] run data modify block ~ ~ ~ Items append value {Slot:10b,id:"minecraft:structure_block",Count:1b,tag:{display:{Name:'[{"text":"\\uc000","color":"white","italic":false,"font":"florcraft:natures_oculus"},{"text":" Druidic Scepter","color":"gold","font":"minecraft:default"}]',Lore:['{"text":"To Unlock:","color":"gray","italic":false}','{"text":"- 10 Sticks","color":"gray","italic":false}','{"text":"- 1 Knowledge Point","color":"gray","italic":false}']},CustomModelData:423003,flor_dat:{recipe:1b,cleared:1b}}}
execute if score @s flor.page matches 1 if entity @p[tag=flor.inside_natures_oculus_gui,tag=flor.know_druidic_scepter,distance=..12] unless data block ~ ~ ~ Items[{Slot:10b}] run data modify block ~ ~ ~ Items append value {Slot:10b,id:"minecraft:structure_block",Count:1b,tag:{display:{Name:'[{"text":"\\uc000","color":"white","italic":false,"font":"florcraft:natures_oculus"},{"text":" Druidic Scepter","color":"green","font":"minecraft:default"}]',Lore:[]},CustomModelData:423009,flor_dat:{recipe:1b,cleared:1b}}}
