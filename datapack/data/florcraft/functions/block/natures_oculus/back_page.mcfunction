...
#execute if score @s flor.page matches 1 run item replace block ~ ~ ~ container.0 with structure_block{display:{Name:'{"translate":"block.flor.natures_oculus.cross_content","color":"white","italic":false}'},BlockEntityTag:{rotation:"NONE",mirror:"NONE",mode:"SAVE"},CustomModelData:423001,flor_dat:{back_button:1,cleared:1}}
execute if score @s flor.page matches 2.. run item replace block ~ ~ ~ container.0 with structure_block{display:{Name:'{"translate":"block.flor.natures_oculus.back","color":"white","italic":false}'},BlockEntityTag:{rotation:"NONE",mirror:"NONE",mode:"SAVE"},CustomModelData:423001,flor_dat:{back_button:1,cleared:1}}
execute if score @s flor.page matches 0 run item replace block ~ ~ ~ container.8 with structure_block{display:{Name:'{"translate":"block.flor.natures_oculus.standard","color":"white","italic":false}'},BlockEntityTag:{rotation:"NONE",mirror:"NONE",mode:"SAVE"},CustomModelData:423002,flor_dat:{next_button:1,cleared:1}}
