...
execute if entity @s[nbt={HurtTime:9s}] run loot spawn ~ ~ ~ loot florcraft:item/arid_essence
execute if entity @s[nbt={HurtTime:9s}] run particle dust 1 0.569 0.22 1 ~ ~ ~ 0.2 0.2 0.2 1 20
