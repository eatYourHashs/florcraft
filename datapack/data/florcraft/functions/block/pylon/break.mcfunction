execute if entity @e[type=item,distance=..2,nbt={Item:{id:"minecraft:oak_wood",count:1}}] run loot spawn ~ ~ ~ loot florcraft:item/pylon
execute if entity @e[type=item,distance=..2,nbt={Item:{id:"minecraft:stripped_oak_wood",count:1}}] run loot spawn ~ ~ ~ loot florcraft:item/pylon
