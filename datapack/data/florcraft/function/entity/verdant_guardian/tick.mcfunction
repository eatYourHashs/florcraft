...
item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick[minecraft:item_model="florcraft:entity/verdant_guardian_body"]
execute if score @s flor.dummy2 matches 11..30 run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick[minecraft:item_model="florcraft:entity/verdant_guardian_body_attacking"]
...
#execute if score @s flor.dummy2 matches 1..10 run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick[minecraft:item_model="florcraft:entity/verdant_guardian_body_preparing"]
